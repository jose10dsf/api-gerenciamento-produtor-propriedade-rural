...
return [
    ...
    'us_date' => 'O campo :attribute é invalido, escolha uma data entre os anos 1000 e 2999.',
    'date_after_or_equal_to_today' => 'O campo :attribute deve ser uma data posterior ou igual a hoje.',
    'date_before_or_equal_to_the_project_deadline' => 'O campo :attribute deve ser uma data anterior ou igual a data do prazo final do projeto.',
    'custom'               => [
        'attribute-name' => [
    ...
    'attributes'           => [
        ...
        'year'                  => 'ano',
        'cpf'                   => 'CPF',
        'activated'             => 'a informação se está ativado',
        'is_super_admin'        => 'a informação se é super administrador',
        'producer_name'         => 'nome do produtor',
        'property_name'         => 'nome da propriedade',
        'rural_cadastre'        => 'cadastro rural'
    ],
];